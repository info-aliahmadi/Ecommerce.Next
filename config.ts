...
const CONFIG = {
  ...
  DASHBOARD_THEME_MODE_STORAGE_NAME: 'kidytoyThemeMode',
  ...
  API_BASEPATH_INTERNAL: process.env.INTERNAL_API_URL, // application api basepath
  ...
  AUTHENTICATION_STORAGE_NAME: 'kititoyAuthenticationStorage',
  AUTHORIZATION_STORAGE_NAME: 'kititoyAuthorizationStorage',
