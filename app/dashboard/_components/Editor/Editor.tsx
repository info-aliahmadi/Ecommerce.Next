...
export default function Editor({ id, name, defaultValue, setFieldValue, onChange }: { id: any, name: any, defaultValue: any, setFieldValue: any, onChange?: any }): React.JSX.Element {
