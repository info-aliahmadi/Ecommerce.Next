...
const DeleteProductTag = ({ row, open, setOpen, refetch }: { row?: MRT_Row<ProductTagModel>; open: boolean; setOpen: (open: boolean) => void; refetch: () => void }) => {
  ...
  const handleSubmit = () => {
    ...
    productTagId && productTagService
