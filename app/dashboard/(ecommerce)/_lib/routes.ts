...
import { SALE_BASE_INFORMATION_MANAGEMENT, SALE_CATEGORY_MANAGEMENT, SALE_ORDER_DISCOUNT_MANAGEMENT, SALE_PRODUCT_ATTRIBUTE_MANAGEMENT, SALE_PRODUCT_MANAGEMENT, SALE_PRODUCT_TAG_MANAGEMENT, SALE_TAX_MANAGEMENT } from "../../_lib/Permissions";
...
const saleRoutes = [
  ...
  },
  {
    ...
    permission: SALE_ORDER_DISCOUNT_MANAGEMENT
  },
  {
