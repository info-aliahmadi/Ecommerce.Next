  ...
  return (
    ...
    >
      ...
      <div className="p-3.5 sm:p-4">
        ...
        {/* Short Description */}
        {shortDesc && (
          <p className="text-xs text-ecommerce-text-muted mt-1 truncate">{shortDesc}</p>
        )}
        ...
        <div className="flex items-center gap-1.5 mt-2">
          ...
          <span className="text-[11px] text-ecommerce-text-muted">{rating}</span>
          <span className="text-[11px] text-ecommerce-text-muted">({reviewCount})</span>
        </div>
        ...
        <div className="flex items-center justify-between mt-3 pt-3 border-t border-ecommerce-border">
          <div className="flex flex-col gap-0.5">
            <div className="flex items-baseline gap-1.5">
              <span className="text-base sm:text-lg font-bold text-ecommerce-text-primary">${price.toFixed(2)}</span>
